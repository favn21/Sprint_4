...
public class QuestionsSectionTest extends BaseTest {
    ...
    public QuestionsSectionTest(int questionIndex, String expectedAnswer) {
    ...
    @Test
    public void testQuestionAnswerTextIsCorrect() {
        ...
        Assert.assertEquals("Неверный текст ответа на вопрос №" + (questionIndex + 1), expectedAnswer, actualAnswer);
    }
}
